...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      testimonials={[
        {
          name: "Максим 'Лев'",
          handle: "@max_lion",
          testimonial: "КРУТОЙ УОКЕР — это всегда на высоте! Мастера знают свое дело, атмосфера мужская, а результат — пушка! Теперь только сюда.",
          rating: 5,
        ...
        },
        {
          name: "Игорь 'Скала'",
          handle: "@igor_rock",
          testimonial: "Долго искал 'своего' барбера, и вот нашел! Каждая стрижка идеальна, борода ухожена. Сервис на уровне. Рекомендую всем мужикам Уфы!",
          rating: 5,
        ...
        },
        {
          name: "Денис 'Гром'",
          handle: "@denis_grom",
          testimonial: "Был приятно удивлен качеством и отношением. Чувствуешь себя как дома, а уходишь новым человеком. Заряжает уверенностью на все 100!",
          rating: 5,
        ...
        },
        {
          name: "Сергей 'Шаман'",
          handle: "@serg_shaman",
          testimonial: "Профессиональный подход к каждому клиенту, внимание к деталям и отличный результат. Это не просто стрижка, это целый ритуал!",
          rating: 5,
        ...
        },
        {
          name: "Артём 'Тигр'",
          handle: "@artem_tiger",
          testimonial: "Лучший барбершоп в городе, без вопросов. Качество, стиль, брутальная атмосфера — здесь есть все, что нужно настоящему мужчине.",
          rating: 5,
      ...
      avatars={[
        {
          src: "http://img.b2bpic.net/free-photo/strong-powerful-african-american-man-black-suit-turtleneck-cap-with-elephant-tusk_627829-1186.jpg",
        ...
        },
        {
          ...
          alt: "Мужчина с ухоженной бородой",
        },
        {
          src: "http://img.b2bpic.net/free-photo/portrait-young-handsome-male_23-2148884406.jpg",
          alt: "Стилизованный портрет мужчины",
        },
        {
          src: "http://img.b2bpic.net/free-photo/chief-financial-officer-large-company-is-thinking-how-deal-with-crisis-pandemic_549566-104.jpg",
          alt: "Мужчина после бритья",
        },
        {
          src: "http://img.b2bpic.net/free-photo/young-handsome-muscled-fit-male-model-man-posing-studio-showing-his-abdominal-muscles-leather-jacket_158538-2317.jpg",
          alt: "Уверенный клиент барбершопа",
        },
      ]}
      ...
      marqueeItems={[
        {
          type: "text-icon",
          text: "Классические стрижки",
          icon: Scissors,
        },
        {
          type: "text-icon",
          text: "Бритье опасной бритвой",
          icon: Feather,
        },
        {
          type: "text-icon",
        ...
        {
          type: "text-icon",
          text: "Премиум-косметика",
          icon: Droplet,
        },
        {
          type: "text-icon",
          text: "Мужская атмосфера",
          icon: Coffee,
        },
      ]}
    />
  ...
  <div id="about" data-section="about">
      ...
      metrics={[
        {
          value: "5000+",
          title: "Довольных братьев",
        },
        {
          value: "10 лет+",
          title: "Опыта в бритье",
        },
        {
          value: "100%",
      ...
      plans={[
        {
          ...
          imageAlt: "Мастер делает мужскую стрижку",
        },
        {
          id: "beard",
          ...
          imageAlt: "Мужчина с ухоженной бородой в барбершопе",
        },
        {
          id: "shave",
          ...
          imageAlt: "Процесс бритья опасной бритвой",
        },
        {
          id: "top-stylist",
          title: "Топ-Стилист",
          ...
          imageAlt: "Стильный мужчина с новой прической",
        },
      ]}
      ...
      members={[
        {
          id: "brodyaga",
          name: "Бродяга",
          role: "Мастер Бритвы, 10 лет стажа",
        ...
        },
        {
          id: "khan",
          name: "Хан",
          role: "Топ-Барбер, 12 лет стажа",
          imageSrc: "http://img.b2bpic.net/free-photo/bearded-shaved-head-arabic-male-with-tattoos-his-crossed-arms-dressed-white-shirt-posing-grey-background_613910-2276.jpg",
        },
        {
          id: "ghost",
          name: "Призрак",
          role: "Молодой Талант, 5 лет стажа",
          imageSrc: "http://img.b2bpic.net/free-photo/professional-barber-man-apron-holding-trimmer-showing-pointing-up-with-fingers-number-three_141793-37278.jpg",
        },
      ]}
  ...
  <div id="contact" data-section="contact">
      ...
      buttons={[
        {
          text: "Telegram: КРУТОЙ УОКЕР",
          href: "#",
        },
        {
          text: "WhatsApp: Ответим быстро",
          href: "#",
        },
        {
